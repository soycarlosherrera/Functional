package org.example._07_inference;
...
public class Inference {
    ...
    public static void main(String[] args) {
        ...
        List<String> alums = NamesUtils.getList("Hugo","Paco","Luis");

        alums.forEach((String name) -> System.out.println(name));

        alums.forEach((name) -> System.out.println(name));

        alums.forEach(System.out::println);
